...
class DatabaseHandler
{
     ...
     *
     * @uses $db = DatabaseHandler::getInstance();
     *
     * @return DatabaseHandler Returns the current instance.
     */
     ...
     *
     * @uses $DatabaseHandler->setQueryOption('name');
     *
     ...
     *
     * @return array|DatabaseHandler Contains the returned rows from the select query.
     * @throws Exception
     */
    ...
    public function getOne($tableName, $columns = '*')
    {
        ...
        if ($res instanceof DatabaseHandler) {
            return $res;
     ...
     *
     * @uses $DatabaseHandler->where('id', 7)->where('title', 'MyTitle');
     *
     ...
     *
     * @uses $DatabaseHandler->orWhere('id', 7)->orWhere('title', 'MyTitle');
     *
     * @param string $whereProp  The name of the database field.
     * @param mixed  $whereValue The value of the database field.
     * @param string $operator   Comparison operator. Default is =
     ...
     *
     * @uses $DatabaseHandler->having('SUM(tags) > 10')
     *
     ...
     *
     * @uses $DatabaseHandler->orHaving('SUM(tags) > 10')
     *
     * @param string $havingProp  The name of the database field.
     * @param mixed  $havingValue The value of the database field.
     * @param string $operator    Comparison operator. Default is =
     ...
     *
     * @uses $DatabaseHandler->join('table1', 'field1 <> field2', 'LEFT')
     *
     ...
     *
     * @uses $DatabaseHandler->orderBy('id', 'desc')->orderBy('name', 'desc', '^[a-z]')->orderBy('name', 'desc');
     *
     ...
     *
     * @uses $DatabaseHandler->groupBy('name');
     *
    ...
    public function _buildDataPairs($tableData, $tableColumns, $isInsert)
    {
        foreach ($tableColumns as $column) {
            ...
            // Subquery value
            if ($value instanceof DatabaseHandler) {
    ...
    /**
     * Method creates new DatabaseHandler object for a subquery generation
     *
    ...
    /**
     * Method returns a copy of a DatabaseHandler subquery object
     *
     * @return DatabaseHandler new DatabaseHandler object
     */
    ...
    /**
     * Get where and what function was called for query stored in DatabaseHandler->trace
     *
